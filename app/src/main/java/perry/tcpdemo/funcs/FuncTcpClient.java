...
import perry.tcpdemo.R;
import perry.tcpdemo.coms.TcpClient;


/**
 * Created by perry Zhu on 2017-04-24.
...
public class FuncTcpClient extends Activity {
    ...
    private void bindID(){
        ...
        editClientIp.setText("10.74.11.14");
        editClientPort.setText("1111");
